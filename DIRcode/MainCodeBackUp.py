...
class Player(pygame.sprite.Sprite):
    ...
    @staticmethod
    def create_bullet():
        return Bullet(player.x[0], player.y[1], BULLET_GREEN)
...
class Bullet(pygame.sprite.Sprite):
    ...
    def draw_bullet(self):
        GAME_SCREEN.blit(self.bullet_img, (self.x, self.y))
...
BULLET_GREEN = pygame.transform.scale(pygame.image.load(os.path.join("Images", "LaserGreen.png")),
                                      (WIDTH // 10, HEIGHT // 20))
